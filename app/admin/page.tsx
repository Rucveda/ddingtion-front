      ...
      <nav className="sticky top-0 z-50 border-b border-white/5 bg-black/40 backdrop-blur-2xl">
        <div className="max-w-[1800px] mx-auto px-10 h-20 flex justify-between items-center relative z-10">
          ...
          <div className="flex gap-4 items-center">
             <Link href="/market?tab=ADMIN" onClick={triggerHaptic} className="text-[10px] font-black text-blue-400 border border-blue-500/20 px-5 py-2 rounded-xl hover:bg-blue-500/10 transition-all uppercase tracking-widest">
                Market Engine
             </Link>
