...
const sections = [
  {
    ...
    body: [
      ...
      "경매 등록, 입찰, 즉시구매, 댓글, 거래 채팅, 거래 신고, 리뷰, 알림 등 서비스 이용 과정에서 생성되는 활동 기록을 저장합니다.",
  ...
  },
  {
    ...
    body: [
      ...
      "거래 채팅, 거래 확정, 댓글, 리뷰 등 이용자 간 거래 흐름을 운영하기 위해 이용합니다.",
      "거래 중 신고 접수 및 분쟁 대응을 위해 신고 사유와 관련 채팅 기록을 운영자가 열람할 수 있습니다.",
      "거래가 완료된 이후의 분쟁은 앱 내 거래 신고가 아닌 관리자 1:1 상담을 통해 처리합니다.",
      "디스코드 인증 여부 확인, 부정 입찰 방지, 서비스 안정성 개선에 이용합니다.",
  ...
  },
  {
    ...
    body: [
      ...
      "경매, 입찰, 거래, 리뷰, 댓글 및 채팅 기록은 서비스 운영을 위해 필요한 기간 동안 보관할 수 있습니다.",
  ...
  },
  {
    ...
    body: [
      ...
      "댓글, 채팅 등 거래 안전과 서비스 운영에 필요한 기록은 요청 즉시 삭제가 제한될 수 있습니다.",
